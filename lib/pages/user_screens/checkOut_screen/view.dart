  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Obx(() => cartCon.totalPrice.value == 0
            ? InkWell(
                onTap: () {
                  Get.back();
              ...
              children: [
                  ...
                  () => Row(
                    ...
                    children: [
                      ...
                      DropdownButton(
                        ...
                        hint: Text(
                            controller.state.addressLabel.value.toString()),
                  ...
                  () => Row(
                    ...
                    children: [
                      ...
                      DropdownButton(
                        iconEnabledColor: LightAppColor.btnColor,
                        hint: Text(
                            controller.state.paymentMethod.value.toString()),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(
                      () => TextWidget(
                        title: cartCon.totalPrice.value.toString(),
                      ),
                    ),
                  ],
                ),
                          ...
                          : RoundButton(
                              ...
                              onPress: () {
                                if (_formKey.currentState!.validate()) {
                                  if (controller.state.addressLabel.value !=
                                          'Select' &&
