                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        ...
                        color: Colors.green,
                        decoration: discount != 0 && discount > 0 ? TextDecoration.lineThrough : TextDecoration.none),
                  ),
                  discount != 0 && discount > 0 ? Padding(
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.hasData) {
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        Get.to(
                                              ...
                                              itemQty: snapshot.data![index].itemQty.toString(),
                          ...
                          : Column(
                            children: [
                              TextWidget(title: 'No items here yet.' ,fontSize: 28.sp,),
                            ],
                          )
                          ;
