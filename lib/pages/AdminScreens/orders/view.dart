...
class OrdersView extends GetView<OrdersController> {
  ...
  Widget _buildlistTile (BuildContext context , AsyncSnapshot<QuerySnapshot> snapshot, index,String datetime){
              ...
              children: [
                InkWell(
                  ...
                  onTap: (){
                    ...
                    Get.to(OrderDetailView(orderId: snapshot.data!.docs[index]['orderId']));



                  },
                  child: Icon(Icons.arrow_forward, color: Colors.blue,size: 30.sp,),
                )
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          bottom: PreferredSize(
            ...
            preferredSize: Size.fromHeight(10.h), // set the height of the custom app bar bottom
            child: Padding(
            ...
            if(snapshot.hasData){
              return ListView.builder(
                ...
                itemBuilder: (context, index){
                  final timeinmili = int.parse(snapshot.data!.docs[index]['orderId'].toString());
                  final dtime = DateTime.fromMicrosecondsSinceEpoch(timeinmili);
                  String formattedDate = DateFormat('dd-MM').format(dtime);
                  print(dtime);
                  return _buildlistTile(context, snapshot, index, formattedDate);
                },);
            }
            return Container();
            // return ListView.builder(
