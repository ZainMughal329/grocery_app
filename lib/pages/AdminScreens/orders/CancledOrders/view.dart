...
class CanceledOrderView extends GetView<CanceledOrderController> {
   CanceledOrderView({Key? key}) : super(key: key);
  final controller = Get.put<CanceledOrderController>(CanceledOrderController());
