...
class ShippedOrderView extends GetView<ShippedOrderController> {
   ShippedOrderView({Key? key}) : super(key: key);
final controller = Get.put<ShippedOrderController>(ShippedOrderController());
